...
export default function NotificationsIcon() {
  return (
    <svg width="800px" height="800px" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" stroke-width="3" stroke="#000000" fill="none">
      ...
      <path className='primary-stroke' d="M50.5,33.49A4.67,4.67,0,0,1,52,41.08" />
      <path className='primary-stroke' d="M53.3,30a8,8,0,0,1,2.59,13" />
      <path className='primary-stroke' d="M14,33.74a4.66,4.66,0,0,0-1.51,7.59" />
      <path className='primary-stroke' d="M11.17,30.26a8,8,0,0,0-2.59,13" /></svg>
  );
}