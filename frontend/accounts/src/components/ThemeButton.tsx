...
const LIGHT_MODE_BUTTON = <svg xmlns='http://www.w3.org/2000/svg' xmlnsXlink='http://www.w3.org/1999/xlink' fill='none' strokeLinecap='square' strokeMiterlimit='10' viewBox='0 0 128 128'>
  <clipPath id='a'><path d='M0 0h128v128H0V0z' /></clipPath>
  <g fillRule='evenodd' clipPath='url(#a)'>
    <path fill='#000000' fillOpacity='0' d='M0 0h128v128H0z' />
    <path fill='#0f0' d='m128 64-25.827 9.185v-18.37zm-18.75-45.256L97.486 43.503 84.497 30.514zM64 0l9.185 25.827h-18.37zM18.744 18.744l24.759 11.77-12.989 12.989zM0 64l25.827-9.185v18.37zm18.744 45.25 11.77-24.753 12.989 12.989zM64 128l-9.185-25.827h18.37zm45.25-18.75L84.497 97.486l12.989-12.989zM32 64c0-17.673 14.327-32 32-32 17.673 0 32 14.327 32 32 0 17.673-14.327 32-32 32-17.673 0-32-14.327-32-32z' className='theme-icon-color' />
  </g>
</svg>;
const DARK_MODE_BUTTON = <svg xmlns='http://www.w3.org/2000/svg' xmlnsXlink='http://www.w3.org/1999/xlink' fill='none' strokeLinecap='square' strokeMiterlimit='10' viewBox='0 0 128 128'>
  <clipPath id='a'><path d='M0 0h128v128H0V0z' /></clipPath>
  <g fillRule='evenodd' clipPath='url(#a)'>
    <path fill='#000000' fillOpacity='0' d='M0 0h128v128H0z' />
    <path fill='#0f0' d='M100.444 115.394c-28.528 20.144-67.99 13.347-88.142-15.18C-7.85 71.685-1.06 32.23 27.467 12.086c-5.007 47.852 26.196 92.024 72.977 103.307z' className='theme-icon-color' />
  </g>
</svg>;
...
export default function () {
  ...
  if (Cookies.get('theme')) 
    isDarkByDefault = Cookies.get('theme') == 'dark';
